...
static constexpr std::array<std::pair<std::string_view, std::size_t>, 84> symbols = {{
    ...
    {"PotionBrewing::mPotionMixes", 245355448},
    {"PotionBrewing::mValidIngredients", 245355520},
    {"PotionBrewing::mValidRecipeInputs", 245355584},
    {"PotionBrewing::mValidContainers", 245355648},
    {"PotionBrewing::mContainerMixes", 245355472},
