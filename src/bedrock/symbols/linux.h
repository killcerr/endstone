...
static constexpr std::array<std::pair<std::string_view, std::size_t>, 61> symbols = {{
    ...
    // NetworkSystem
    {"_ZN13NetworkSystem4sendERK17NetworkIdentifierRK6Packet11SubClientId", 140170752},
    // PistonBlockActor
    ...
    {"_ZN6RakNet22RNS2_Windows_Linux_36027Send_Windows_Linux_360NoVDPEiPNS_19RNS2_SendParametersEPKcj", 214786384},
    // RakPeerHelper
